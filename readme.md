...
## Navigation
- The `src` folder contains the code in C++ for the allergy icer. The `include` and `lib` folders will contain other code files in the future as I change the code structure.
...
## Future Plans (in this project's Github Issues)
